...
3. `model` — defaults to `kimi-k2.7-code` and uses the same text input. The prompt text matches this default (the previously stale `qwen3-coder` hint has been fixed in source).
