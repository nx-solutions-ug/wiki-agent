...
9. **Flatten the wiki for GitHub**:
   ...
   - Metadata files (`.git`, `config.json`, `.last-update-report.md`, `.last-update-title.txt`, `_plan.md`) are excluded.
